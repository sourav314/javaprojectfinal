...
class ImagePanel extends JPanel {
    ...
    private static final double ANIMATION_SPEED = 0.8; // lower = slower fade

    public ImagePanel() {
        setLayout(null);
        setDoubleBuffered(true); // enable double buffering for smoothness

        // ✅ Fixed resource path
        img = new ImageIcon(getClass().getResource("/main_project/image/logo.png")).getImage();
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (img != null) {
            ...
            // Smooth fade in/out loop using cosine easing
...
public class test {
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> {
            ...
            // Add action listeners for opening new windows
            loginBtn.addActionListener(e -> new LoginWindow().setVisible(true));
            signupBtn.addActionListener(e -> new SignUpWindow().setVisible(true));
            ...
            // ✅ Increased from 400 → 450 to move text slightly downward
